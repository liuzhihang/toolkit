...
import com.liuzhihang.toolkit.ui.UrlOperate;
 ...
 */
public class UrlOperateAction extends AnAction {
    ...
    public void actionPerformed(AnActionEvent event) {
        ...
        DialogWrapper dialog = new UrlOperate(project, psiFile, editor, psiClass);
        dialog.show();
    }
